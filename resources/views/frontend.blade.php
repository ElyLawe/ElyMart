...
<head>
  ...
  <title>ElyMart - Belanja Mudah & Hemat</title>
  <meta name="description" content="ElyMart - Belanja kebutuhan sehari-hari dengan mudah dan hemat.">
  <meta name="keywords" content="ElyMart, belanja online, minimarket, produk, promo">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="{{ url('/') }}" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">ElyMart</h1><span>.</span>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#portfolio">Promo</a></li>
          <li><a href="#team">Kategori</a></li>
      ...
      <a class="btn-getstarted" href="{{ route('login') }}"><i class="bi bi-person"></i> Login</a>
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="hero-content">
              <div class="hero-tag" data-aos="fade-up" data-aos-delay="250">
                ...
                <span class="tag-text">BELANJA MUDAH &amp; HEMAT</span>
              </div>

              <h1 class="hero-headline" data-aos="fade-up" data-aos-delay="300">Belanja Kebutuhanmu Lebih Mudah di ElyMart</h1>

              <p class="hero-text" data-aos="fade-up" data-aos-delay="350">Temukan berbagai kebutuhan sehari-hari, produk pilihan, dan promo menarik dengan pengalaman belanja yang mudah dan nyaman.</p>
            ...
            <div class="stats-grid">
              <div class="stat-card stat-card-primary" data-aos="zoom-in" data-aos-delay="350">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-title">Produk Tersedia</span>
                </div>
              </div>
              ...
              <div class="stat-card" data-aos="zoom-in" data-aos-delay="450">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-title">Layanan Cepat</span>
                </div>
              </div>
              ...
              <div class="stat-card stat-card-accent" data-aos="zoom-in" data-aos-delay="500">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-title">Promo Pilihan</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row gy-5 align-items-center">
          ...
          <div class="col-xl-6 aos-init aos-animate" data-aos="fade-left" data-aos-delay="300">
            <div class="about-content">
              <div class="section-subtitle">Tentang ElyMart</div>
              <h2>Kebutuhan Harian Ada di ElyMart</h2>
              <p class="lead-text">
          ...
          <div class="row g-4 justify-content-center">
            ...
            <div class="col-6 col-md-3">
              <div class="stat-item">
                ...
                <span class="stat-label">Layanan Cepat</span>
              </div>
            </div>
            <div class="col-6 col-md-3">
              <div class="stat-item">
                <span class="stat-number">500+</span>
                <span class="stat-label">Promo Pilihan</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
              <div class="project-card">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-2.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-2.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-mobile">
              <div class="project-card featured">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-4.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-4.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
              <div class="project-card">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-6.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-6.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <div class="project-card">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-8.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-8.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
              <div class="project-card">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-1.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-1.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-mobile">
              <div class="project-card">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-3.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-3.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
              <div class="project-card featured">
                <div class="image-wrapper">
                  ...
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-7.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
              <div class="project-card">
                <div class="image-wrapper">
                  <img src="{{ asset('assets/img/portfolio/portfolio-9.webp') }}" alt="Project showcase" class="img-fluid" loading="lazy">
                  <div class="hover-overlay">
                    <div class="overlay-actions">
                      <a href="{{ asset('assets/img/portfolio/portfolio-9.webp') }}" class="glightbox action-btn" data-gallery="portfolio">
                        <i class="bi bi-eye"></i>
                      </a>
                      <a href="#" class="action-btn">
                        <i class="bi bi-link-45deg"></i>
        ...
        <div class="cta-section" data-aos="zoom-in" data-aos-delay="300">
          <div class="cta-content">
            ...
            <h3>Belanja Mudah, Hemat, dan Nyaman</h3>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperiam.</p>
            <div class="cta-buttons">
              <a href="#contact" class="btn-cta-primary">Mulai Belanja <i class="bi bi-arrow-right"></i></a>
              <a href="#services" class="btn-cta-secondary"><i class="bi bi-play-circle"></i> Lihat Produk</a>
            </div>
          </div>
        ...
        <div class="row g-5">
          <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
            <div class="sidebar-content">
              ...
              <h2>Belanja Kebutuhan Harian Tanpa Ribet</h2>
              ...
              <div class="action-buttons">
                <a href="#" class="btn-main">Mulai Belanja</a>
                <a href="#" class="btn-outline">Explore Promo</a>
              </div>
            </div>
          </div>
    ...
    <section id="testimonials" class="testimonials section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          ...
          <!-- Right Testimoni Pelanggan Slider -->
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-card">
                    ...
                    <div class="author-info">
                      <img src="{{ asset('assets/img/person/person-f-2.webp') }}" alt="Client" class="author-img" loading="lazy">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-card">
                    ...
                    <div class="author-info">
                      <img src="{{ asset('assets/img/person/person-m-5.webp') }}" alt="Client" class="author-img" loading="lazy">
                      <div class="author-details">
                        <h5>Marcus Webb</h5>
                        <span>Tech Lead</span>
                      </div>
                ...
                <div class="swiper-slide">
                  <div class="testimonial-card">
                    ...
                    <div class="author-info">
                      <img src="{{ asset('assets/img/person/person-f-9.webp') }}" alt="Client" class="author-img" loading="lazy">
                      <div class="author-details">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-card">
                    ...
                    <div class="author-info">
                      <img src="{{ asset('assets/img/person/person-m-11.webp') }}" alt="Client" class="author-img" loading="lazy">
                      <div class="author-details">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-card">
                    ...
                    <div class="author-info">
                      <img src="{{ asset('assets/img/person/person-f-14.webp') }}" alt="Client" class="author-img" loading="lazy">
                      <div class="author-details">
                        <h5>Olivia Chen</h5>
          ...
          </div><!-- End Right Testimoni Pelanggan Slider -->

        </div>

      </div>

    </section><!-- /Testimoni Pelanggan Section -->
    ...
    <section id="team" class="team section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="team-card">
              <div class="member-img">
                <img src="{{ asset('assets/img/person/person-m-1.webp') }}" class="img-fluid" alt="Kategori Member">
          ...
          </div><!-- End Kategori Member -->

          <!-- Kategori Member 2 -->
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="team-card">
              <div class="member-img">
                <img src="{{ asset('assets/img/person/person-f-2.webp') }}" class="img-fluid" alt="Kategori Member">
                <div class="social-overlay">
                  <div class="social-links">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-linkedin"></i></a>
          ...
          <!-- Kategori Member 3 - Featured -->
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="team-card featured">
              <div class="member-img">
                <img src="{{ asset('assets/img/person/person-m-5.webp') }}" class="img-fluid" alt="Kategori Member">
                <div class="social-overlay">
                  <div class="social-links">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="team-card">
              <div class="member-img">
                <img src="{{ asset('assets/img/person/person-f-7.webp') }}" class="img-fluid" alt="Kategori Member">
                <div class="social-overlay">
                  <div class="social-links">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-linkedin"></i></a>
            ...
            <div class="col-lg-8">
              <div class="stats-wrapper">
                <div class="stat-item">
                  ...
                  <span class="stat-label">Kategori Members</span>
                </div>
      ...
      <div class="row gy-4">
        <div class="col-lg-3 col-md-6 footer-info">
          <a href="{{ url('/') }}" class="logo d-flex align-items-center mb-4">
            <span class="sitename">ElyMart</span>
          </a>
          <p>ElyMart adalah tempat belanja kebutuhan sehari-hari dengan mudah, cepat, dan hemat.</p>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          <h4>Shop</h4>
          <ul>
            <li><a href="#services">New Arrivals</a></li>
            <li><a href="#services">Best Sellers</a></li>
            <li><a href="#services">Sale Items</a></li>
            <li><a href="#services">Men's Collection</a></li>
            <li><a href="#services">Women's Collection</a></li>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            <li><a href="#contact">Kontak Us</a></li>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-newsletter">
            ...
            <p>Dapatkan informasi promo dan produk terbaru ElyMart.</p>
    ...
    <div class="container footer-bottom">
      <div class="row gy-3">
        <div class="col-md-6 order-2 order-md-1">
          <div class="copyright">
            <p>Â© <span>Copyright</span> <strong class="sitename">ElyMart</strong>. All Rights Reserved.</p>
          </div>
          <div class="credits">
